...
public class MethodOverloadin0 {
	/**
	...
	public static void main(String[] args) {
		...
		System.out.println("sum:2 "+MethodOverloadin0.addNumbers(45, 55));
		System.out.println("sum:3 "+addNumbers(47, 53,58));
		System.out.println("sum:4 "+MethodOverloadin0.addNumbers(47, 53.56,58));
	}
